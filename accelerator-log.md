...
{
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/trevorputbrese/spring-sensors-v2",
  "projectName" : "spring-sensors-rabbit",
  "publisherRepository" : "supply-chain-images/images",
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local/spring-sensors-publisher->supply-chain-images/...(truncated)]
